 ...
 function RefreshEnvironment() {
    ...
    Install-VSExtension -extensionUrl "https://marketplace.visualstudio.com/_apis/public/gallery/publishers/AdamRDriscoll/vsextensions/PowerShellToolsforVisualStudio2017-18561/5.3.1/vspackage" -extensionFileName "PowerShellTools.5.3.1.vsix" -extensionFilepath $extensionFilepath