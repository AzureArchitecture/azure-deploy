...
document 'arm-template' {
    ...
    $parameters = GetTemplateParameter -Path $env:ACTION_GROUP_PATH/azuredeploy.json;
    $resources = Get-TemplateResources -Path  $env:ACTION_GROUP_PATH/azuredeploy.json;
    $jsonParameters = Get-Content -Path $env:ACTION_GROUP_PATH/azuredeploy.parameters.json;
...
'
    ...
    # Set document title
    Title "Action Group Definition: $env:templateName"
   ...
   Section 'File Details' {
      'Resource File: [' + 'azuredeploy' + '.json](' +  $env:ACTION_GROUP_PATH + '/' + 'azuredeploy' + '.json + )'
      'Metadata File: [' + 'azuredeploy' + '.metadata.json](' +  $env:ACTION_GROUP_PATH + '/' + 'azuredeploy' + '.metadata.json + )'
      'Parameters File: [' + 'azuredeploy' + '.parameter.json](' +  $env:ACTION_GROUP_PATH + '/' + 'azuredeploy' + '.parameters.json + )'
    }
